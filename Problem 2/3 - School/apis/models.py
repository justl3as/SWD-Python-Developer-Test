...
class Classes(models.Model):
    school = models.ForeignKey(
        Schools, on_delete=models.CASCADE, null=False, blank=False
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["school", "class_order"], name="unique_school_order"
            )
        ]
...
class Personnel(models.Model):
    ...
    school_class = models.ForeignKey(
        Classes, on_delete=models.CASCADE, null=False, blank=False
    )
...
class StudentSubjectsScore(models.Model):
    student = models.ForeignKey(
        Personnel, on_delete=models.CASCADE, null=False, blank=False
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["student", "subjects"], name="unique_subject_score"
            )
        ]
